...
class KubeflowModelEndpointManagement:
    ...
    def _create_secret(self) -> None:
        ...
        _secret_yaml = _secret_yaml.replace("$(S3_ENDPOINT)", self.s3_endpoint)
...
if __name__ == '__main__':
    _kubeflow_model_endpoint_management: KubeflowModelEndpointManagement = KubeflowModelEndpointManagement(profile_namespace=ARGS.profile_namespace,
