...
class EvalClf:
    ...
    def confusion(self, normalize: str = None) -> list:
        """
        ...
        :return: list
            Confusion Matrix
        """
        return confusion_matrix(y_true=self.obs, y_pred=self.pred, labels=None, sample_weight=None, normalize=normalize).tolist()
