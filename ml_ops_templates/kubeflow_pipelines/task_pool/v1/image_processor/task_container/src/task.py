...
PARSER.add_argument('-file_paths', nargs='+', required=True, default=None, help='file paths of the images')
...
PARSER.add_argument('-salt_pepper_number_of_pixel_edges', type=int, nargs='+', required=False, default=(100000, 500000), help='number of pixel edges used to generate salt & pepper noise')
...
PARSER.add_argument('-watermark_files', nargs='+', required=False, default=None, help='complete file paths of the watermark noise')
...
if __name__ == '__main__':
    if ARGS.file_paths:
        ARGS.file_paths = ast.literal_eval(ARGS.file_paths[0])
    if ARGS.salt_pepper_number_of_pixel_edges:
        ARGS.salt_pepper_number_of_pixel_edges = tuple(ARGS.salt_pepper_number_of_pixel_edges)
    if ARGS.watermark_files:
        ARGS.watermark_files = ast.literal_eval(ARGS.watermark_files[0])
