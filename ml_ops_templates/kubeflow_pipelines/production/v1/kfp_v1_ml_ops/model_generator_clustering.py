...
Kubeflow Pipeline Component: Clustering Model Generator
...
def generate_clustering_model(model_name: str,
                              ...
                              volume_dir: str = '/mnt',
                              display_name: str = 'Clustering Model Generator',
    ...
    :param suffix_parallel_mode: str
        Suffix used to save data health check output in parallel mode
    ...
    :return: dsl.ContainerOp
        Container operator for clustering model generator
    """
    _volume: dict = {volume_dir: volume if volume is None else volume.volume}
    _arguments: list = ['-model_name', model_name,
    ...
    if suffix_parallel_mode is not None:
        _arguments.extend(['-suffix_parallel_mode', suffix_parallel_mode])
