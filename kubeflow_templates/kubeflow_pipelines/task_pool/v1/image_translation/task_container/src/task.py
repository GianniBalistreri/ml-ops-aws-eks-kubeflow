...
PARSER.add_argument('-image_width', type=str, required=False, default=256, help='width of the images')
...
PARSER.add_argument('-kwargs', type=Any, required=False, default=None, help='key-word arguments')
