...
def generate_model(model_name: str,
    ...
    if warm_start:
        _model_param = ModelGeneratorCluster(model_name=model_name).get_model_parameter()
    _model_generator: ModelGeneratorCluster = ModelGeneratorCluster(model_name=model_name, cluster_params=_model_param)
