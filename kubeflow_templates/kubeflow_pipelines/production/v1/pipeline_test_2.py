...
def task_1(data_set_path: str,
    ...
    _task: dsl.ContainerOp = dsl.ContainerOp(name='analytical_data_type',
                                             image='711117404296.dkr.ecr.eu-central-1.amazonaws.com/ml-ops-analytical-data-types:v16',
                                             ...
                                             file_outputs={'analytical_data_type': '/tmp/outputs/analytical_data_type/data'},
...
def task_2(data_set_path: str,
    ...
    _task: dsl.ContainerOp = dsl.ContainerOp(name='data_health_check',
                                             ...
                                             container_kwargs=None,
                                             artifact_argument_paths=None,
                                             #file_outputs={'data_health_check': '/tmp/outputs/data_health_check/data',
                                             #              'missing_data': '/tmp/outputs/missing_data/data',
                                             #              'invariant': '/tmp/outputs/invariant/data',
                                             #              'duplicated': '/tmp/outputs/duplicated/data',
                                             #              'valid_features': '/tmp/outputs/valid_features/data',
                                             #              'prop_valid_features': '/tmp/outputs/prop_valid_features/data'
                                             #              },
                                             output_artifact_paths=None,
                                             is_exit_handler=False,
                                             pvolumes=volume if volume is None else _volume
...
def pipeline() -> None:
    ...
    _task_2: dsl.ContainerOp = task_2(data_set_path=_data_set_path,
                                      analytical_data_types=_task_1.outputs['analytical_data_type'],
                                      output_bucket_name=_output_bucket_name,
