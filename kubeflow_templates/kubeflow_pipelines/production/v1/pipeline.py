...
def for_loop(start: int, end: int) -> NamedTuple('outputs', [('range', list)]):
    ...
    :return: NamedTuple
        Output values
    """
    _range: list = [float(i) for i in range(start, end, 1)]
    return [_range]
...
def task_4(a: float, b: float, volume: dsl.VolumeOp = None, volume_dir: str = '/mnt') -> dsl.ContainerOp:
    """
    Generate container operator for task 4
    ...
    _task: dsl.ContainerOp = dsl.ContainerOp(name='xxx',
                                             ...
                                             container_kwargs=None,
                                             artifact_argument_paths=None,
                                             file_outputs={'output': '/task_4_output.txt'},
                                             output_artifact_paths=None,
                                             is_exit_handler=False,
                                             pvolumes=volume if volume is None else _volume
                                             )
    _task.set_display_name('Task 4')
    _task = add_container_op_parameters(container_op=_task,
                                        n_cpu_request='1',
                                        n_cpu_limit=None,
                                        n_gpu=None,
...
def task_5(a: float, b: float, volume: dsl.VolumeOp = None, volume_dir: str = '/mnt') -> dsl.ContainerOp:
    """
    Generate container operator for task 5
    ...
    _task: dsl.ContainerOp = dsl.ContainerOp(name='xxx',
                                             ...
                                             container_kwargs=None,
                                             artifact_argument_paths=None,
                                             file_outputs={'output': '/task_5_output.txt'},
                                             output_artifact_paths=None,
                                             is_exit_handler=False,
                                             pvolumes=volume if volume is None else _volume
                                             )
    _task.set_display_name('Task 5')
    _task = add_container_op_parameters(container_op=_task,
                                        n_cpu_request='1',
                                        n_cpu_limit=None,
                                        n_gpu=None,
...
def task_6(a: float, b: float, volume: dsl.VolumeOp = None, volume_dir: str = '/mnt') -> dsl.ContainerOp:
    """
    Generate container operator for task 6
    ...
    _task: dsl.ContainerOp = dsl.ContainerOp(name='xxx',
                                             ...
                                             container_kwargs=None,
                                             artifact_argument_paths=None,
                                             file_outputs={'output': '/task_6_output.txt'},
                                             output_artifact_paths=None,
                                             is_exit_handler=False,
                                             pvolumes=volume if volume is None else _volume
                                             )
    _task.set_display_name('Task 6')
    _task = add_container_op_parameters(container_op=_task,
                                        n_cpu_request='1',
                                        n_cpu_limit=None,
                                        n_gpu=None,
...
def task_7(a: float, b: float, volume: dsl.VolumeOp = None, volume_dir: str = '/mnt') -> dsl.ContainerOp:
    """
    Generate container operator for task 7
    ...
    _task: dsl.ContainerOp = dsl.ContainerOp(name='xxx',
                                             ...
                                             container_kwargs=None,
                                             artifact_argument_paths=None,
                                             file_outputs={'output': '/task_7_output.txt'},
                                             output_artifact_paths=None,
                                             is_exit_handler=False,
                                             pvolumes=volume if volume is None else _volume
                                             )
    _task.set_display_name('Task 7')
    _task = add_container_op_parameters(container_op=_task,
                                        n_cpu_request='1',
                                        n_cpu_limit=None,
                                        n_gpu=None,
...
def task_8(a: float, b: float, volume: dsl.VolumeOp = None, volume_dir: str = '/mnt') -> dsl.ContainerOp:
    """
    Generate container operator for task 8
    ...
    _task: dsl.ContainerOp = dsl.ContainerOp(name='xxx',
                                             ...
                                             container_kwargs=None,
                                             artifact_argument_paths=None,
                                             file_outputs={'output': '/task_8_output.txt'},
                                             output_artifact_paths=None,
                                             is_exit_handler=True,
                                             pvolumes=volume if volume is None else _volume
                                             )
    _task.set_display_name('Task 8')
    _task = add_container_op_parameters(container_op=_task,
                                        n_cpu_request='1',
                                        n_cpu_limit=None,
                                        n_gpu=None,
...
def pipeline() -> None:
    ...
    with dsl.ParallelFor(loop_args=_task_for_loop.output, parallelism=None) as item:
        _task_4: dsl.ContainerOp = task_1(a=float(item.value), b=float(item.value), volume=_task_3.pvolume)
